...
const UserHomePage: NextPage<Props> = function ({ userInfo }: any) {
          ...
          <Flex align="center" p="2">
            ...
            <Button
              ...
              onClick={async () => {
                ...
                const messageResp = postMessage(postData);
                if ((await messageResp).result === false) {
        ...
        <VStack spacing="12px" mt="6">
          {messageList.map((messageData) => {
            return (
              <>
                <MessageItem
                  key={`message_item-${userInfo.uid}-${messageData.id}`}
                  item={messageData}
                  uid={userInfo.uid}
